...
-- your gate today. You know that American, Mexican, and Canadian 
-- citizens don't need visas, so they can just continue their trips. 
-- You don't need to check their passports for visas! You only 
...
SELECT name, country from travelers where country  not in ('USA', 'Mexico', 'Canada');